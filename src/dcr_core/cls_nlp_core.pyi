...
class NLPCore:
    ...
    JSON_NAME_FILE_NAME: ClassVar[str]
    ...
    JSON_NAME_GLYPH_FONT: ClassVar[str]
    JSON_NAME_GLYPH_FONT_SIZE: ClassVar[str]
    ...
    PARSE_ATTR_GLYPH_FONT: ClassVar[str]
    PARSE_ATTR_GLYPH_SIZE: ClassVar[str]
