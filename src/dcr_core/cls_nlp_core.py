...
class NLPCore:
    ...
    JSON_NAME_CONTAINER_HEADING: ClassVar[str] = "heading"
    ...
    JSON_NAME_JSON_INCL_LIST_NUMBER: ClassVar[str] = "jsonInclListNumber"
    JSON_NAME_JSON_INCL_PARAMS: ClassVar[str] = "jsonInclParams"
    JSON_NAME_JSON_INCL_SENTENCES: ClassVar[str] = "jsonInclSENTENCES"
    ...
    JSON_NAME_NO_FOOTERS: ClassVar[str] = "noFooters"
    JSON_NAME_NO_HEADERS: ClassVar[str] = "noHeaders"
    ...
    JSON_NAME_NO_LINES_HEADING: ClassVar[str] = "noLinesHeading"
    JSON_NAME_NO_LINES_LIST_BULLET: ClassVar[str] = "noLinesListBullet"
    JSON_NAME_NO_LINES_LIST_NUMBER: ClassVar[str] = "noLinesListNumber"
    JSON_NAME_NO_LINES_PAGE: ClassVar[str] = "noLinesPage"
    JSON_NAME_NO_LINES_PARA: ClassVar[str] = "noLinesPara"
    JSON_NAME_NO_LINES_TABLE: ClassVar[str] = "noLinesTable"
    ...
    JSON_NAME_NO_PARAS_PAGE: ClassVar[str] = "noParasPage"
    JSON_NAME_NO_PDF_PAGES: ClassVar[str] = "noPDFPages"
    JSON_NAME_NO_SENTENCES: ClassVar[str] = "noSentences"
    JSON_NAME_NO_SENTENCES_PARA: ClassVar[str] = "noSentencesPara"
    JSON_NAME_NO_TABLES: ClassVar[str] = "noTables"
    JSON_NAME_NO_WORDS: ClassVar[str] = "noWords"
    JSON_NAME_NO_WORDS_LINE: ClassVar[str] = "noWordsLine"
    JSON_NAME_NO_WORDS_PAGE: ClassVar[str] = "noWordsPage"
    JSON_NAME_NO_WORDS_PARA: ClassVar[str] = "noWordsPara"
