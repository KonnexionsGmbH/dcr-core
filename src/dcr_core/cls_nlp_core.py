...
class NLPCore:
    ...
    JSON_NAME_LT_HEADING_FILE_INCL_NO_CTX: ClassVar[str] = "ltHeadingFileInclNo_ctx"
    ...
    JSON_NAME_LT_TABLE_FILE_INCL_EMPTY_COLUMNS: ClassVar[str] = "ltTableFileInclEmpty_columns"
